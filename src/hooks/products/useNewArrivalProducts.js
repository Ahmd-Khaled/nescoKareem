...
const useNewArrivalProducts = () => {
  ...
  if (newArrivalProducts) {
    if (newArrivalProducts.data) {
      newArrivalData = newArrivalProducts.data;
      newArrivalCurrentPage = newArrivalProducts.current_page;
      newArrivalLastPage = newArrivalProducts.last_page;
      newArrivalTotal = newArrivalProducts.total
      newArrivalPagesArray = createArray(newArrivalLastPage)
    }
  }
  
  return [newArrivalData, newArrivalCurrentPage, newArrivalPagesArray, newArrivalTotal];
}
